var num1, num2, respuesta, contadorSumasCorrectas = 0, startTime;
...
function comenzar() {
    if (contadorSumasCorrectas === 10) {
        ...
        //txt_msj.innerHTML = "¡Juego terminado! Te tardaste " + elapsedTime + " segundos.";
        Swal.fire({
